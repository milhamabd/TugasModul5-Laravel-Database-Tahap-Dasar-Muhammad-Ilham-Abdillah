...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            ...
            <button type="button" class="navbar-toggler" data-bs-toggle="collapse" d
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    <li class="nav-item col-2 col-md-auto"><a
                        href="<?php echo e(route('home')); ?>" class="nav-link">Home</a></li>
                    <li class="nav-item col-2 col-md-auto"><a
                        href="<?php echo e(route('employees.index')); ?>" class="nav-link active">Employee List</a></li>
                </ul>
            ...
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="row">
                    <div class="col-md-12 d-grid">
                        <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-outline-dark
                        btn-lg mt-3"> <i class="bi-arrow-left-circle me-2"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\milhamabd\Praktikum Modul 5\resources\views/employee/show.blade.php ENDPATH**/ ?>