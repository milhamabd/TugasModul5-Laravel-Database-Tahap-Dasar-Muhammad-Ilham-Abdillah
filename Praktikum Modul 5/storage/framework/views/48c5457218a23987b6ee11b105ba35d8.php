                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="firstName" id="firstName" value="<?php echo e(old('age')); ?>" placeholder="Enter First Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Last Name</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value="<?php echo e(old('age')); ?>" placeholder="Enter Last Name">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input class="form-control" type="text" name="email" id="email" value="<?php echo e(old('age')); ?>" placeholder="Enter Email">
                        </div>
                        <div class="col-md-6 mb-3">
...
<?php /**PATH C:\Users\milhamabd\Praktikum Modul 5\resources\views/employee/create.blade.php ENDPATH**/ ?>